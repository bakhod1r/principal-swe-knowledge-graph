---
title: Concatenative and Stack Based
tags:
  - programming
  - paradigms
  - principal-swe
...
Point-free (tacit) programming, postfix notation, stack primitives (dup, drop, swap in Forth), and JVM/Wasm bytecode stack engines.
