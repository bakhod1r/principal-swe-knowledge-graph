---
title: When to Introduce a New Language
tags:
  - programming
  - polyglot
  - principal-swe
...
Managing organizational cognitive load, domain-specific language fit (ML, HFT, Web), language governance RFCs, and golden path tooling.
