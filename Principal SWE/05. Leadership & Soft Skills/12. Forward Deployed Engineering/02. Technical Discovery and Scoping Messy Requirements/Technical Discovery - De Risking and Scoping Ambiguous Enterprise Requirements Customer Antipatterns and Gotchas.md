...
# Technical Discovery - De Risking and Scoping Ambiguous Enterprise Requirements Customer Antipatterns and Gotchas

## 1. Definition
**Technical Discovery - De Risking and Scoping Ambiguous Enterprise Requirements Customer Antipatterns and Gotchas** represents a mission-critical field engineering capability, enterprise customer architecture standard, and delivery invariant within **Forward Deployed Engineering (FDE) & Customer Architecture**.
Translating ambiguous client business problems into concrete engineering deliverables, identifying technical blockers early, scoping realistic MVPs, and managing customer expectations. Covering Critical client failure modes, compliance gotchas, and field troubleshooting runbooks.
...
## 2. Mental Model
```text
Forward Deployed Engineering Operating Pipeline for Technical Discovery - De Risking and Scoping Ambiguous Enterprise Requirements Customer Antipatterns and Gotchas:
...
## 3. Usage
```text
FDE Enterprise Customer Playbook for Technical Discovery - De Risking and Scoping Ambiguous Enterprise Requirements Customer Antipatterns and Gotchas:
