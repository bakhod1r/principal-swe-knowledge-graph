...
Linux systems engineering and kernel diagnostics: POSIX shell scripting, Bash automation, text manipulation (sed/awk), process lifecycle (signals, cgroups), systemd unit management, package repositories, ext4/xfs filesystems, kernel bootloader sequence, eBPF tracing, and network troubleshooting.
