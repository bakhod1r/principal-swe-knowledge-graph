---
title: Enterprise GitHub Features & Security
tags:
  - git
  - github
  - version-control
...
# 🏛️ Enterprise GitHub Features & Security

Enterprise security and cloud developer tooling: GitHub Advanced Security (GHAS), secret scanning with push protection, CodeQL SAST code analysis, Dependabot security updates, GitHub Codespaces, and GitHub Packages registry.

```text
Enterprise GitHub Features & Security
│
