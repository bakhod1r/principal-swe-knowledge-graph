---
title: GitHub Collaboration & Team Governance
tags:
  - git
  - github
  - version-control
...
# 🏛️ GitHub Collaboration & Team Governance

Enterprise team governance and pull request workflows: GitHub Organizations, team access matrices, branch protection rules, CODEOWNERS rules, fork vs clone models, collaborative PR reviews, and GitHub Projects kanban automations.

```text
GitHub Collaboration & Team Governance
│
