...
Deep AWS platform engineering: EC2 instance architectures, VPC subnets & NAT Gateways, IAM security policies, S3 data lakes, Route 53 latency routing, CloudWatch metrics & alarms, Auto Scaling, RDS Aurora, DynamoDB global tables, CloudFront CDNs, ElastiCache, ECR, Lambda serverless, and EKS/ECS container platforms.
