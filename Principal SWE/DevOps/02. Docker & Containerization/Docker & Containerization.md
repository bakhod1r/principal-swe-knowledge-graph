...
Container runtime internals and image optimization: Linux namespaces, cgroups, overlayfs, Dockerfile multi-stage builds, rootless containers, container security scanning, local dev environments (Compose), registry architectures, and distroless base images.
