---
title: Cloudflare & Edge Computing
tags:
  - devops
...
Global edge platform architecture: Cloudflare Workers (V8 isolates), Workers KV, Durable Objects, D1 SQL, R2 object storage, Hyperdrive connection pooling, Pages Jamstack, Cloudflare Zero Trust (Access/Tunnel), WAF DDoS shields, and Edge SSL/TLS termination.
