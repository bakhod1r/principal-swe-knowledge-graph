...
Enterprise Kubernetes cluster management: Control plane components (kube-apiserver, etcd), Pod lifecycle, Deployments, StatefulSets, Services & Ingress (Envoy/Nginx), NetworkPolicies, RBAC, CNI plugins (Cilium), CSI storage, HPA/VPA autoscaling, scheduling affinity, and Helm charts.
