...
Declarative multi-cloud infrastructure automation: HCL syntax, provider configurations, resource dependency graphs, remote state locking (S3/DynamoDB), reusable modules, workspaces, plan/apply pipelines, terratest automation, drift detection, and HCP Terraform.
