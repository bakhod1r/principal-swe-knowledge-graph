---
title: "HCP Architecture and Fundamentals"
tags:
  - devops
...
# HCP Architecture and Fundamentals

## 1. Definition
**HCP Architecture and Fundamentals** represents a core infrastructure paradigm, automation standard, and reliability primitive within **Terraform & Infrastructure as Code**.
HCP in Terraform & Infrastructure as Code. Covering Foundational architecture, declarative invariants, and core primitives.
...
## 2. Mental Model
```text
Production Cloud Platform & Deployment Pipeline for HCP Architecture and Fundamentals:
...
## 3. Usage
```yaml
# Production Declarative Infrastructure / Kubernetes Manifest for HCP Architecture and Fundamentals
apiVersion: apps/v1
kind: Deployment
metadata:
  name: hcparchitectureandfundamentals-service
  labels:
    app.kubernetes.io/name: hcparchitectureandfundamentals
...
spec:
  ...
  selector:
    matchLabels:
      app: hcparchitectureandfundamentals
  template:
    metadata:
      labels:
        app: hcparchitectureandfundamentals
    spec:
      containers:
        - name: app
          image: internal-registry.corp/platform/hcparchitectureandfundamentals:v1.0.0
          resources:
            requests:
              cpu: 250m
              memory: 512Mi
