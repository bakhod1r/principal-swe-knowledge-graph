...
### 1. 📂 `01. Profiling Subsystems (pprof)`
...
### 2. 📂 `02. Execution Tracing & Scheduler Latency`
...
### 5. 📂 `05. Production Profiling & Fleet Telemetry`
...
### 9. 📂 `09. Primitives & Concurrency Performance`
...
### 11. 📂 `11. SIMD Vectorization & Mechanical Sympathy`
