...
### 1. 📂 `01. Method Declarations & Receivers`
...
### 3. 📂 `03. Interface Fundamentals & Contracts`
...
### 4. 📂 `04. Type Assertions, Switches & Inspection`
...
### 5. 📂 `05. Runtime Internals (iface, eface, itab)`
...
### 7. 📂 `07. Interface Architecture & Design Patterns`
