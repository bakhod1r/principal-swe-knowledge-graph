---
title: "Red Black Foundations and Invariants"
tags:
  - review
  - computer-science
  - algorithms
...
## 1. Definition
**Red Black** represents a fundamental algorithmic paradigm and structural invariant within **09. Trees**.
...
## 2. Mental Model
```text
Invariant State Machine for Red Black:
+--------------------+        State Transition        +--------------------+
