...
├── Skip List/
└── Common Linked List Algorithms & Operations/
```
...
### [[Doubly Linked List]]
  - [[Doubly Linked List Delete Operations (O(1) Node Removal)]]
  - [[Doubly Linked List Insert Operations (Head, Tail, Before, After)]]
...
### [[Unrolled Linked List]]
  ...
  - [[Unrolled Linked List Search and Node Traversal Operations]]
