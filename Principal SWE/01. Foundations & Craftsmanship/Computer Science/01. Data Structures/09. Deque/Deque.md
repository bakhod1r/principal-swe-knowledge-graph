...
├── Chunked Block Deque/
├── Work-Stealing Deque/
├── Monotonic Deque Algorithms/
└── Common Deque Algorithms & Operations/
```
...
### [[Circular Array Deque]]
  ...
  - [[Circular Deque Peek Front and Peek Back Operations]]
...
### [[Chunked Block Deque]]
  ...
  - [[Chunked Block Deque Push, Pop, and Insert Operations]]
...
### [[Common Deque Algorithms & Operations]]
  - [[0-1 BFS Shortest Path Algorithm using Deque]]
  - [[Palindrome Verification using Double-Ended Queue]]
