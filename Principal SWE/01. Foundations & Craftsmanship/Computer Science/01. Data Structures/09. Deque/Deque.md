...
Double-Ended Queue supporting O(1) operations at both ends with chunked arrays across 2 specialized domains.

```text
Deque
│
├── 01. Core Invariants & Operations
...
│
└── 02. Implementation Architectures
...
### 1. 📂 01. Core Invariants & Operations
...
### 2. 📂 02. Implementation Architectures
