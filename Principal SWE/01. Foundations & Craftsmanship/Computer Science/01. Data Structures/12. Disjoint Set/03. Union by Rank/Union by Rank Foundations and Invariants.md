---
title: "Union by Rank Foundations and Invariants"
tags:
  - computer-science
  - algorithms
  - dsa
...
## 1. Definition
**Union by Rank** represents a fundamental algorithmic paradigm and structural invariant within **12. Disjoint Set**.
...
## 2. Mental Model
```text
Invariant State Machine for Union by Rank:
+--------------------+        State Transition        +--------------------+
