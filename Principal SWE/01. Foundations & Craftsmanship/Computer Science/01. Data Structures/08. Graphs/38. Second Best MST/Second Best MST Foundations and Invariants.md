---
title: "Second Best MST Foundations and Invariants"
tags:
  - review
  - computer-science
  - algorithms
...
## 1. Definition
**Second Best MST** represents a fundamental algorithmic paradigm and structural invariant within **11. Graphs**.
...
## 2. Mental Model
```text
Invariant State Machine for Second Best MST:
+--------------------+        State Transition        +--------------------+
...
## 3. Usage
```go
// Production pattern for Second Best MST
type SecondBestMST struct {
    // Internal state descriptors and size invariants
    size int
}

func NewSecondBestMST() *SecondBestMST {
