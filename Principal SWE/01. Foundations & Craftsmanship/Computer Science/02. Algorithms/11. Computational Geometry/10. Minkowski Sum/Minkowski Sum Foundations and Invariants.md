...
## 1. Definition
**Minkowski Sum** represents a fundamental algorithmic paradigm and structural invariant within **20. Computational Geometry**.
...
## 2. Mental Model
```text
Invariant State Machine for Minkowski Sum:
+--------------------+        State Transition        +--------------------+
