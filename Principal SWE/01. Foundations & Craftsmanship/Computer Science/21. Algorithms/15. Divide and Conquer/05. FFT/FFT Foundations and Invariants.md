---
title: "FFT Foundations and Invariants"
tags:
  - computer-science
  - algorithms
  - dsa
...
## 1. Definition
**FFT** represents a fundamental algorithmic paradigm and structural invariant within **15. Divide and Conquer**.
...
## 2. Mental Model
```text
Invariant State Machine for FFT:
+--------------------+        State Transition        +--------------------+
