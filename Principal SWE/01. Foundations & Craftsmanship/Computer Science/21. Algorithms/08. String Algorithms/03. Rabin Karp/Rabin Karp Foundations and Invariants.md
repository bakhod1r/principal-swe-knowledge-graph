...
## 1. Definition
**Rabin Karp** represents a fundamental algorithmic paradigm and structural invariant within **17. String Algorithms**.
...
## 2. Mental Model
```text
Invariant State Machine for Rabin Karp:
+--------------------+        State Transition        +--------------------+
...
## 3. Usage
```go
// Production pattern for Rabin Karp
