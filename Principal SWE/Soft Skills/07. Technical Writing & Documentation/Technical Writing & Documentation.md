...
Technical communication and documentation architecture: Audience persona modeling, Docs-as-Code tooling (Diataxis framework: Tutorials, How-To, Reference, Explanation), architectural RFCs, API references, content research, technical blogging, documentation search optimization, and knowledge base maintenance.
