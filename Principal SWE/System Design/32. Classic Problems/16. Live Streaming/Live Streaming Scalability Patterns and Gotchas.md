---
title: "Live Streaming Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Live Streaming Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Live Streaming**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Live Streaming
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: live-streaming-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
