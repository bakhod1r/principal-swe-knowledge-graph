---
title: "Proximity Service Maps Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Proximity Service Maps Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Proximity Service Maps**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Proximity Service Maps
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: proximity-service-maps-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: proximity-service-maps-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
