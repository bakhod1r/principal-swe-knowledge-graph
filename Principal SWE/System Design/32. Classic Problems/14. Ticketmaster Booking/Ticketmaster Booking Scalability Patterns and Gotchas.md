---
title: "Ticketmaster Booking Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Ticketmaster Booking Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Ticketmaster Booking**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Ticketmaster Booking
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: ticketmaster-booking-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: ticketmaster-booking-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
