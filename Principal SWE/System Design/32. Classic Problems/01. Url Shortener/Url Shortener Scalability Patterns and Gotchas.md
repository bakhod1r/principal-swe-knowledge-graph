...
## 1. Definition
**Url Shortener Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Url Shortener**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Url Shortener
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: url-shortener-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
