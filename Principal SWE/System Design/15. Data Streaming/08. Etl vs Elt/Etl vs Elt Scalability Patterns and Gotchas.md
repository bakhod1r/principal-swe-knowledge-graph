---
title: "Etl vs Elt Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Etl vs Elt Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Etl vs Elt**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Etl vs Elt
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: etl-vs-elt-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: etl-vs-elt-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
