---
title: "Trino Presto Distributed Query Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Trino Presto Distributed Query Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Trino Presto Distributed Query**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Trino Presto Distributed Query
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: trino-presto-distributed-query-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: trino-presto-distributed-query-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
