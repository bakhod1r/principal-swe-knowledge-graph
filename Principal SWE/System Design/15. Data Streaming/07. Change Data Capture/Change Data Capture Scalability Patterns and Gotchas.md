---
title: "Change Data Capture Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Change Data Capture Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Change Data Capture**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Change Data Capture
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: change-data-capture-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: change-data-capture-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
