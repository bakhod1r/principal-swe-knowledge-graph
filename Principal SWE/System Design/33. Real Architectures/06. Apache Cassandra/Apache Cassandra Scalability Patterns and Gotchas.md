---
title: "Apache Cassandra Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Apache Cassandra Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Apache Cassandra**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Apache Cassandra
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: apache-cassandra-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: apache-cassandra-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
