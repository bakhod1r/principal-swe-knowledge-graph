---
title: "Realtime Payments UPI and FPS Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Realtime Payments UPI and FPS Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Realtime Payments UPI and FPS**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Realtime Payments UPI and FPS
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: realtime-payments-upi-and-fps-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: realtime-payments-upi-and-fps-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
