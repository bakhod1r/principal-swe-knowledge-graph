---
title: "REST Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**REST Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **REST**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for REST
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: rest-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
