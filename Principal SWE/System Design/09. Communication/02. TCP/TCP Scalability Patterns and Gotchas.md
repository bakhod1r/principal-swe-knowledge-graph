...
## 1. Definition
**TCP Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **TCP**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for TCP
