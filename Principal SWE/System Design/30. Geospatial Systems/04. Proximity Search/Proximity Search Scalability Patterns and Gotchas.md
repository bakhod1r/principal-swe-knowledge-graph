---
title: "Proximity Search Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Proximity Search Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Proximity Search**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Proximity Search
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: proximity-search-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: proximity-search-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
