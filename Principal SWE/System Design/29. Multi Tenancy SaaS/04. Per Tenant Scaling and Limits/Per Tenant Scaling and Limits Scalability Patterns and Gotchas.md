---
title: "Per Tenant Scaling and Limits Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Per Tenant Scaling and Limits Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Per Tenant Scaling and Limits**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Per Tenant Scaling and Limits
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: per-tenant-scaling-and-limits-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: per-tenant-scaling-and-limits-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
