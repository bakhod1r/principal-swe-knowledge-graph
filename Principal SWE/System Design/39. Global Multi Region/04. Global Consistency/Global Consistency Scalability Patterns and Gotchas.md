---
title: "Global Consistency Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Global Consistency Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Global Consistency**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Global Consistency
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: global-consistency-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: global-consistency-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
