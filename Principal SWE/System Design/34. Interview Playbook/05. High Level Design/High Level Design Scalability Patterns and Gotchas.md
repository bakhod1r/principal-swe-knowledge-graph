---
title: "High Level Design Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**High Level Design Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **High Level Design**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for High Level Design
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: high-level-design-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: high-level-design-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
