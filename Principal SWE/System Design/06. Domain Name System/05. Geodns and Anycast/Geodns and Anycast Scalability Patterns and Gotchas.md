---
title: "Geodns and Anycast Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Geodns and Anycast Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Geodns and Anycast**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Geodns and Anycast
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: geodns-and-anycast-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: geodns-and-anycast-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
