...
## 1. Definition
**API Gateway Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **API Gateway**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for API Gateway
