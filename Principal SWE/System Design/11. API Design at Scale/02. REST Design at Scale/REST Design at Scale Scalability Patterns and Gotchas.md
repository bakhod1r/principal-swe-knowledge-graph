---
title: "REST Design at Scale Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**REST Design at Scale Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **REST Design at Scale**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for REST Design at Scale
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: rest-design-at-scale-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: rest-design-at-scale-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
