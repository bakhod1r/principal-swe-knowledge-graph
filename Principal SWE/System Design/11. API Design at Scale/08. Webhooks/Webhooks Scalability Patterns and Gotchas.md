---
title: "Webhooks Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Webhooks Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Webhooks**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Webhooks
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: webhooks-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
