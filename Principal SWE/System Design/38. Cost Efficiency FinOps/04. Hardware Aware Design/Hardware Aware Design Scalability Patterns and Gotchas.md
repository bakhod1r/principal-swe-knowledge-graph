---
title: "Hardware Aware Design Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Hardware Aware Design Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Hardware Aware Design**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Hardware Aware Design
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: hardware-aware-design-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: hardware-aware-design-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
