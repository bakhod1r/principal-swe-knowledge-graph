---
title: "Coordination Services Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Coordination Services Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Coordination Services**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Coordination Services
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: coordination-services-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: coordination-services-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
