---
title: "Alerting and on Call Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Alerting and on Call Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Alerting and on Call**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Alerting and on Call
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: alerting-and-on-call-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: alerting-and-on-call-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
