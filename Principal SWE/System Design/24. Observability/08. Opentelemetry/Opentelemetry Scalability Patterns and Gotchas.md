---
title: "Opentelemetry Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Opentelemetry Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Opentelemetry**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Opentelemetry
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: opentelemetry-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
