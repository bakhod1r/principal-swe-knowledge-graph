---
title: "TLS and Https Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**TLS and Https Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **TLS and Https**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for TLS and Https
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: tls-and-https-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: tls-and-https-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
