---
title: "Nats Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Nats Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Nats**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Nats
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: nats-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
