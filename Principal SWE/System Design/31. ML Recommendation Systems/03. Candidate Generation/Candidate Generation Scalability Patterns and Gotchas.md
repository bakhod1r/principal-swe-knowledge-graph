...
## 1. Definition
**Candidate Generation Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Candidate Generation**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Candidate Generation
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: candidate-generation-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
