---
title: "Noisy Neighbor Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Noisy Neighbor Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Noisy Neighbor**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Noisy Neighbor
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: noisy-neighbor-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: noisy-neighbor-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
