---
title: "Pull CDN Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Pull CDN Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Pull CDN**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Pull CDN
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: pull-cdn-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: pull-cdn-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
