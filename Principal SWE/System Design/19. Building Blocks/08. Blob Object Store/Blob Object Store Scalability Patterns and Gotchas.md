---
title: "Blob Object Store Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Blob Object Store Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Blob Object Store**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Blob Object Store
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: blob-object-store-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: blob-object-store-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
