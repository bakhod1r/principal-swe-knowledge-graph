---
title: "Consistent Hashing Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Consistent Hashing Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Consistent Hashing**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Consistent Hashing
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: consistent-hashing-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: consistent-hashing-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
