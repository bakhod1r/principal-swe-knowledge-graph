---
title: "Choosing a Database Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Choosing a Database Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Choosing a Database**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Choosing a Database
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: choosing-a-database-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: choosing-a-database-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
