---
title: "Relational Rdbms Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Relational Rdbms Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Relational Rdbms**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Relational Rdbms
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: relational-rdbms-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: relational-rdbms-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
