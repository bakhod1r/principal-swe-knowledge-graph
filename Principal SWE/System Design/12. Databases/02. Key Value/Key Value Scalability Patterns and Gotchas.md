---
title: "Key Value Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Key Value Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Key Value**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Key Value
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: key-value-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
