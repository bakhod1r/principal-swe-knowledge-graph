---
title: "Graph Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Graph Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Graph**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Graph
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: graph-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
