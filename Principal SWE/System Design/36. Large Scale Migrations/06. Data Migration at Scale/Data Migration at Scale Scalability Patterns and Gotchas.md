...
## 1. Definition
**Data Migration at Scale Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Data Migration at Scale**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Data Migration at Scale
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: data-migration-at-scale-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: data-migration-at-scale-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
