---
title: "Dual Write and Backfill Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Dual Write and Backfill Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Dual Write and Backfill**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Dual Write and Backfill
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: dual-write-and-backfill-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: dual-write-and-backfill-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
