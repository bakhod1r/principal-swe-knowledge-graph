---
title: "Build vs Buy Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Build vs Buy Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Build vs Buy**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Build vs Buy
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: build-vs-buy-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: build-vs-buy-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
