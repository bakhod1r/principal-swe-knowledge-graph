---
title: "Consistency vs Availability Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Consistency vs Availability Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Consistency vs Availability**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Consistency vs Availability
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: consistency-vs-availability-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: consistency-vs-availability-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
