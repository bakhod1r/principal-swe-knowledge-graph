---
title: "Synthetic Monitoring and Rum Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Synthetic Monitoring and Rum Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Synthetic Monitoring and Rum**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Synthetic Monitoring and Rum
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: synthetic-monitoring-and-rum-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: synthetic-monitoring-and-rum-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
