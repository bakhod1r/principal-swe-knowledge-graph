---
title: "Error Budgets Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Error Budgets Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Error Budgets**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Error Budgets
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: error-budgets-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: error-budgets-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
