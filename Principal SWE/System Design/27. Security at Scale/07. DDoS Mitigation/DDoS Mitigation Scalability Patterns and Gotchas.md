---
title: "DDoS Mitigation Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**DDoS Mitigation Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **DDoS Mitigation**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for DDoS Mitigation
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: ddos-mitigation-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
