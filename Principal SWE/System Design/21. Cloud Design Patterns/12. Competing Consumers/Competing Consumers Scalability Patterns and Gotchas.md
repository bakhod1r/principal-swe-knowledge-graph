---
title: "Competing Consumers Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Competing Consumers Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Competing Consumers**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Competing Consumers
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: competing-consumers-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: competing-consumers-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
