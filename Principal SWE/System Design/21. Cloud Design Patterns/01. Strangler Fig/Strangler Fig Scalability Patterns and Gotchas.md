---
title: "Strangler Fig Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Strangler Fig Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Strangler Fig**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Strangler Fig
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: strangler-fig-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: strangler-fig-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
