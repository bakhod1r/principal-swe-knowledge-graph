---
title: "API Composition Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**API Composition Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **API Composition**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for API Composition
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: api-composition-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: api-composition-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
