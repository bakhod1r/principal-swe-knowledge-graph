---
title: "Erasure Coding and Durability Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Erasure Coding and Durability Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Erasure Coding and Durability**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Erasure Coding and Durability
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: erasure-coding-and-durability-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: erasure-coding-and-durability-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
