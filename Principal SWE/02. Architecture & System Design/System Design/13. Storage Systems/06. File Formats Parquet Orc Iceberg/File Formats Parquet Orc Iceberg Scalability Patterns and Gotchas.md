---
title: "File Formats Parquet Orc Iceberg Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**File Formats Parquet Orc Iceberg Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **File Formats Parquet Orc Iceberg**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for File Formats Parquet Orc Iceberg
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: file-formats-parquet-orc-iceberg-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: file-formats-parquet-orc-iceberg-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
