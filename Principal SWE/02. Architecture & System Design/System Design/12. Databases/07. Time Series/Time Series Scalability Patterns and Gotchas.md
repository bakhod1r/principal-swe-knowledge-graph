...
## 1. Definition
**Time Series Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Time Series**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Time Series
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: time-series-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
