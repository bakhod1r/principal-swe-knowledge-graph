---
title: "Backup Restore and Pitr Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Backup Restore and Pitr Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Backup Restore and Pitr**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Backup Restore and Pitr
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: backup-restore-and-pitr-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: backup-restore-and-pitr-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
