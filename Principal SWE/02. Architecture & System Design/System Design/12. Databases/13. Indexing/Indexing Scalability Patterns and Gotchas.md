...
## 1. Definition
**Indexing Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Indexing**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Indexing
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: indexing-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
