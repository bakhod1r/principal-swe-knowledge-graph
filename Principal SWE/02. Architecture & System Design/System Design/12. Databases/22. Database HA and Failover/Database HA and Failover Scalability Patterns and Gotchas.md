---
title: "Database HA and Failover Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Database HA and Failover Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Database HA and Failover**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Database HA and Failover
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: database-ha-and-failover-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: database-ha-and-failover-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
