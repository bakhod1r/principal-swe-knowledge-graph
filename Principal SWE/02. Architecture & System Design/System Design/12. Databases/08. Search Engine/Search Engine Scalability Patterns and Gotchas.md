---
title: "Search Engine Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Search Engine Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Search Engine**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Search Engine
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: search-engine-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
