---
title: "Vector Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Vector Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Vector**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Vector
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: vector-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
