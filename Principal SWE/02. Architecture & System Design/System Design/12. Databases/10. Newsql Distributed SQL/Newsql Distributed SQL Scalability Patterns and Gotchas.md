---
title: "Newsql Distributed SQL Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Newsql Distributed SQL Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Newsql Distributed SQL**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Newsql Distributed SQL
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: newsql-distributed-sql-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: newsql-distributed-sql-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
