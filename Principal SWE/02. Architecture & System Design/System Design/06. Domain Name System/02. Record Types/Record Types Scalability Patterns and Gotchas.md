---
title: "Record Types Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Record Types Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Record Types**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Record Types
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: record-types-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: record-types-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
