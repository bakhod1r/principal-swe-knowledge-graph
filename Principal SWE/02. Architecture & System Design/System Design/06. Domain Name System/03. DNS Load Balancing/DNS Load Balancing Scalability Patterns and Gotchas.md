---
title: "DNS Load Balancing Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**DNS Load Balancing Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **DNS Load Balancing**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for DNS Load Balancing
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: dns-load-balancing-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: dns-load-balancing-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
