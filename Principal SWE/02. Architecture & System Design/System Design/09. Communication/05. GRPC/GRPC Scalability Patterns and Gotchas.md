---
title: "GRPC Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**GRPC Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **GRPC**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for GRPC
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: grpc-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
