---
title: "RPC Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**RPC Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **RPC**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for RPC
