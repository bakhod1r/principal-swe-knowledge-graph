---
title: "Fermi Estimation Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Fermi Estimation Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Fermi Estimation**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Fermi Estimation
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: fermi-estimation-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: fermi-estimation-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
