---
title: "Number Tables Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Number Tables Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Number Tables**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Number Tables
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: number-tables-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: number-tables-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
