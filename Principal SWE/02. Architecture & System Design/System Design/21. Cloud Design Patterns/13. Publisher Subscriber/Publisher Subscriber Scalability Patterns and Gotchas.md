---
title: "Publisher Subscriber Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Publisher Subscriber Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Publisher Subscriber**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Publisher Subscriber
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: publisher-subscriber-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: publisher-subscriber-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
