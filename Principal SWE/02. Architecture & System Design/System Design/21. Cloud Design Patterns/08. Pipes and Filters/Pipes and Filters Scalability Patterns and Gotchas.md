---
title: "Pipes and Filters Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Pipes and Filters Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Pipes and Filters**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Pipes and Filters
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: pipes-and-filters-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: pipes-and-filters-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
