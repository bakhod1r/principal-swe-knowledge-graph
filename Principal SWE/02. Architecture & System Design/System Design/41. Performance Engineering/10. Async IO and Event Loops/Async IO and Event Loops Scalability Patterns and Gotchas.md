---
title: "Async IO and Event Loops Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Async IO and Event Loops Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Async IO and Event Loops**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Async IO and Event Loops
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: async-io-and-event-loops-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: async-io-and-event-loops-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
