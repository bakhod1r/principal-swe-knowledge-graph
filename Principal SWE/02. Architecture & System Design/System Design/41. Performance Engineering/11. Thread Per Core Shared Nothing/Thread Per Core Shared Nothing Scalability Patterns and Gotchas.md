---
title: "Thread Per Core Shared Nothing Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Thread Per Core Shared Nothing Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Thread Per Core Shared Nothing**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Thread Per Core Shared Nothing
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: thread-per-core-shared-nothing-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: thread-per-core-shared-nothing-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
