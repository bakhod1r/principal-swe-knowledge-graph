---
title: "Hedged Requests Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Hedged Requests Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Hedged Requests**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Hedged Requests
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: hedged-requests-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: hedged-requests-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
