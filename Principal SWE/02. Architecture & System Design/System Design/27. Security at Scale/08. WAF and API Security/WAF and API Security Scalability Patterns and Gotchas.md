...
## 1. Definition
**WAF and API Security Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **WAF and API Security**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for WAF and API Security
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: waf-and-api-security-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: waf-and-api-security-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
