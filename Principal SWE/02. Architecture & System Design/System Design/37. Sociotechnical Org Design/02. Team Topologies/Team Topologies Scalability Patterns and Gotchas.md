---
title: "Team Topologies Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Team Topologies Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Team Topologies**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Team Topologies
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: team-topologies-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: team-topologies-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
