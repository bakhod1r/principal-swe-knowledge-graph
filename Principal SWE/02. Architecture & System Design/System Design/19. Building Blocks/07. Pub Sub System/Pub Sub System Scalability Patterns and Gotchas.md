---
title: "Pub Sub System Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Pub Sub System Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Pub Sub System**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Pub Sub System
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: pub-sub-system-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: pub-sub-system-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
