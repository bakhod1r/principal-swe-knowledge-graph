...
## 1. Definition
**Rate Limiter Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Rate Limiter**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Rate Limiter
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: rate-limiter-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
