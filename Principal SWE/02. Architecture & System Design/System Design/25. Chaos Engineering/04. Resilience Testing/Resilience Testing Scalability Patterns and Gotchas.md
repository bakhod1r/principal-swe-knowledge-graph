---
title: "Resilience Testing Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Resilience Testing Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Resilience Testing**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Resilience Testing
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: resilience-testing-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: resilience-testing-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
