---
title: "Apache Kafka Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Apache Kafka Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Apache Kafka**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Apache Kafka
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: apache-kafka-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
