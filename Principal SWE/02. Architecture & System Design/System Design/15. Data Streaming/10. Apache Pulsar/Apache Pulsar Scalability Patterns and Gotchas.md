---
title: "Apache Pulsar Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Apache Pulsar Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Apache Pulsar**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Apache Pulsar
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: apache-pulsar-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: apache-pulsar-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
