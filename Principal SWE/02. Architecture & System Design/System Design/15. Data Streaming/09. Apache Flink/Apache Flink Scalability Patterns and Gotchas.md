---
title: "Apache Flink Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Apache Flink Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Apache Flink**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Apache Flink
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: apache-flink-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: apache-flink-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
