---
title: "Dead Letter Queues Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Dead Letter Queues Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Dead Letter Queues**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Dead Letter Queues
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: dead-letter-queues-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: dead-letter-queues-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
