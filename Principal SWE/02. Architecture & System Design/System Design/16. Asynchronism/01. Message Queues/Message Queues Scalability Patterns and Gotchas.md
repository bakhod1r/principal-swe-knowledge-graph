---
title: "Message Queues Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Message Queues Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Message Queues**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Message Queues
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: message-queues-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: message-queues-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
