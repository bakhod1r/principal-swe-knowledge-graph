---
title: "Redundancy and Failure Domains Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Redundancy and Failure Domains Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Redundancy and Failure Domains**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Redundancy and Failure Domains
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: redundancy-and-failure-domains-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: redundancy-and-failure-domains-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
