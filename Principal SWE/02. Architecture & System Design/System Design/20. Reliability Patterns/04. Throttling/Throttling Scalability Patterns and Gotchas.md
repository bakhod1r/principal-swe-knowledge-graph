...
## 1. Definition
**Throttling Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Throttling**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Throttling
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: throttling-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
