---
title: "Hotel Reservation System Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Hotel Reservation System Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Hotel Reservation System**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Hotel Reservation System
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: hotel-reservation-system-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: hotel-reservation-system-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
