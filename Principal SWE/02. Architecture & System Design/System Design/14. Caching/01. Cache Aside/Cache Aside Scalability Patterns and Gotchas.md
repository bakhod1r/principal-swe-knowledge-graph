---
title: "Cache Aside Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Cache Aside Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Cache Aside**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Cache Aside
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: cache-aside-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
