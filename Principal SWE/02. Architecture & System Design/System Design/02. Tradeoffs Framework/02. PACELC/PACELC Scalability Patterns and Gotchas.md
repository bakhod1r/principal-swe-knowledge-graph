---
title: "PACELC Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**PACELC Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **PACELC**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for PACELC
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: pacelc-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
