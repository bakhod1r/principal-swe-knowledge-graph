---
title: "Consistency Models Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Consistency Models Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Consistency Models**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Consistency Models
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: consistency-models-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: consistency-models-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
