---
title: "Digital Wallets and Mobile Pay Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Digital Wallets and Mobile Pay Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Digital Wallets and Mobile Pay**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Digital Wallets and Mobile Pay
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: digital-wallets-and-mobile-pay-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: digital-wallets-and-mobile-pay-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
