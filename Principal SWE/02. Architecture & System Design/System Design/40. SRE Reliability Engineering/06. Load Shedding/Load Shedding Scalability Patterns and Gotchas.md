---
title: "Load Shedding Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Load Shedding Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Load Shedding**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Load Shedding
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: load-shedding-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: load-shedding-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
