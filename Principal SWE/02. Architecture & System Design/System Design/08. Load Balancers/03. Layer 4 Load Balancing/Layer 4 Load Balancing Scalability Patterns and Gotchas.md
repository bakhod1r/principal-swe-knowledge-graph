---
title: "Layer 4 Load Balancing Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Layer 4 Load Balancing Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Layer 4 Load Balancing**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Layer 4 Load Balancing
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: layer-4-load-balancing-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: layer-4-load-balancing-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
