---
title: "Data Mesh Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Data Mesh Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Data Mesh**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Data Mesh
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: data-mesh-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
