---
title: "Expand Contract Pattern Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Expand Contract Pattern Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Expand Contract Pattern**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Expand Contract Pattern
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: expand-contract-pattern-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: expand-contract-pattern-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
