---
title: "Containers and Docker Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Containers and Docker Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Containers and Docker**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Containers and Docker
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: containers-and-docker-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: containers-and-docker-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
