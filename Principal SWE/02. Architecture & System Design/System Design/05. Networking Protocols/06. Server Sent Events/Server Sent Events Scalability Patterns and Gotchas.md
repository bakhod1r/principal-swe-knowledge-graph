---
title: "Server Sent Events Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Server Sent Events Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Server Sent Events**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Server Sent Events
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: server-sent-events-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: server-sent-events-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
