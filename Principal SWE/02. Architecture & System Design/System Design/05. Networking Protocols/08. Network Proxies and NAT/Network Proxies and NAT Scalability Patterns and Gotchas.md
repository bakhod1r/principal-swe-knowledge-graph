...
## 1. Definition
**Network Proxies and NAT Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Network Proxies and NAT**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Network Proxies and NAT
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: network-proxies-and-nat-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: network-proxies-and-nat-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
