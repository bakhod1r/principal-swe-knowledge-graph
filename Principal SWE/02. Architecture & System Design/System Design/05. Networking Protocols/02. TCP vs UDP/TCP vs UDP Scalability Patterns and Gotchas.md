---
title: "TCP vs UDP Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**TCP vs UDP Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **TCP vs UDP**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for TCP vs UDP
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: tcp-vs-udp-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: tcp-vs-udp-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
