---
title: "Websockets Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Websockets Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Websockets**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Websockets
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: websockets-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
