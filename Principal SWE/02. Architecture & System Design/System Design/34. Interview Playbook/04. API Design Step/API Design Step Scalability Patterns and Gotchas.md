---
title: "API Design Step Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**API Design Step Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **API Design Step**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for API Design Step
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: api-design-step-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: api-design-step-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
