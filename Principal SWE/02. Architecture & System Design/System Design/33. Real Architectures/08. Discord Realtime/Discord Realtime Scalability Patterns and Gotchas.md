---
title: "Discord Realtime Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Discord Realtime Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Discord Realtime**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Discord Realtime
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: discord-realtime-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: discord-realtime-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
