---
title: "Active Active Architecture Scalability Patterns and Gotchas"
tags:
  - review
  - system-design
  - architecture
...
## 1. Definition
**Active Active Architecture Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Active Active Architecture**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Active Active Architecture
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: active-active-architecture-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: active-active-architecture-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
