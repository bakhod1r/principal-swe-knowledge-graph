---
title: "Geo Routing Scalability Patterns and Gotchas"
tags:
  - system-design
  - architecture
  - distributed-systems
...
## 1. Definition
**Geo Routing Scalability Patterns** defines the horizontal sharding models, multi-tier caching architectures, and throughput scaling strategies for **Geo Routing**.
...
## 3. Usage
```yaml
# Kubernetes & Envoy Horizontal Autoscaling Topology for Geo Routing
apiVersion: autoscaling/v2
kind: HorizontalPodAutoscaler
metadata:
  name: geo-routing-autoscaler
spec:
  scaleTargetRef:
    apiVersion: apps/v1
    kind: Deployment
    name: geo-routing-service
  minReplicas: 10
  maxReplicas: 200
  metrics:
  - type: Resource
