...
# 🏛️ Redis & in Memory Architectures

High-performance in-memory data structures: Strings, Hashes, Lists, Sets, Sorted Sets (SkipList zset), Bitmaps, HyperLogLog, Geospatial, Pub/Sub channels, Lua scripting atomicity, persistence (RDB snapshots & AOF logs), Redis Sentinel HA, Redis Cluster hash slots, and caching topologies.
