---
title: Prompt Engineering & LLM Alignment
tags:
  - ai
  - machine-learning
...
# 🏛️ Prompt Engineering & LLM Alignment

Systematic LLM prompting, parameter calibration, and alignment techniques: Tokenization mechanics, sampling hyper-parameters (temperature, top-p, top-k), Chain-of-Thought, ReAct, Few-Shot in-context learning, and output reliability guardrails.

```text
Prompt Engineering & LLM Alignment
│
