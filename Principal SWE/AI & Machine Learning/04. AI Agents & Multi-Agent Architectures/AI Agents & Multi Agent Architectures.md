---
title: AI Agents & Multi Agent Architectures
tags:
  - ai
  - machine-learning
...
# 🏛️ AI Agents & Multi Agent Architectures

Autonomous agent design and multi-agent coordination: Agent loop state machines, tool orchestration, Model Context Protocol (MCP), episodic & semantic memory, hierarchical planning, swarms, and agent observability.
