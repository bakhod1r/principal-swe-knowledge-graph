---
title: Claude Code, Subagents & Workflows
tags:
  - ai
  - machine-learning
...
# 🏛️ Claude Code, Subagents & Workflows

Autonomous CLI agent workflows and context engineering: Claude Code CLI operations, CLAUDE.md context architecture, custom SKILL.md skills, subagent parallelism, lifecycle hooks, and context compaction.

```text
Claude Code, Subagents & Workflows
│
