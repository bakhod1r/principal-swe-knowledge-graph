---
title: "AWS High Availability and Disaster Recovery Critical Anti Patterns and Failure Modes"
tags:
  - best-practices
...
# AWS High Availability and Disaster Recovery Critical Anti Patterns and Failure Modes

## 1. Definition
**AWS High Availability and Disaster Recovery Critical Anti Patterns and Failure Modes** represents an enterprise-grade best practice and operational engineering standard within **AWS Cloud Architecture Best Practices**.
Multi-AZ active-active deployments, Auto Scaling Groups, Route 53 health routing, S3 Cross-Region Replication, and RTO/RPO budgets. Covering Critical failure modes, common anti-patterns, and mitigation checklists.
...
## 2. Mental Model
```text
Best Practice Lifecycle & Verification Flow for AWS High Availability and Disaster Recovery Critical Anti Patterns and Failure Modes:
...
## 3. Usage
```yaml
# Production Verification Specification for AWS High Availability and Disaster Recovery Critical Anti Patterns and Failure Modes
standard:
  name: "AWS High Availability and Disaster Recovery Critical Anti Patterns and Failure Modes"
