---
title: Threat Modeling & Risk Management
tags:
  - cyber-security
  - appsec
...
Systematic security architecture and threat modeling: STRIDE threat model, PASTA methodology, DREAD risk scoring, Attack Trees, CVSS v3/v4 vulnerability scoring, and Zero Trust Architecture (ZTA).
