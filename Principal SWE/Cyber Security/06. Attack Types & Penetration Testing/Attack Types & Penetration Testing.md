---
title: Attack Types & Penetration Testing
tags:
  - cyber-security
  - appsec
...
# 🏛️ Attack Types & Penetration Testing

Offensive adversary simulation and exploit mechanics: Phishing, Ransomware mitigation, Man-in-the-Middle (MitM), DDoS volumetric flood mitigations, Buffer Overflows & memory corruption, and Red Team penetration testing.

```text
Attack Types & Penetration Testing
│
