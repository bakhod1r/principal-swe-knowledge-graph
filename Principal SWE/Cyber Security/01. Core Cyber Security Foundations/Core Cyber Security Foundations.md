---
title: Core Cyber Security Foundations
tags:
  - cyber-security
  - appsec
...
# 🏛️ Core Cyber Security Foundations

Information security theory and defensive IT fundamentals: The CIA triad (Confidentiality, Integrity, Availability), OS kernel hardening, network security protocols (IPsec, 802.1X), virtualization boundaries, security diagnostics, and CTF challenges.
