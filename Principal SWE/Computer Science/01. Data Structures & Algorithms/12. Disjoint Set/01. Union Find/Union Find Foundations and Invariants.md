---
title: "Union Find Foundations and Invariants"
tags:
  - computer-science
  - algorithms
  - dsa
...
## 1. Definition
**Union Find** represents a fundamental algorithmic paradigm and structural invariant within **12. Disjoint Set**.
...
## 2. Mental Model
```text
Invariant State Machine for Union Find:
+--------------------+        State Transition        +--------------------+
...
## 3. Usage
```go
// Production pattern for Union Find
