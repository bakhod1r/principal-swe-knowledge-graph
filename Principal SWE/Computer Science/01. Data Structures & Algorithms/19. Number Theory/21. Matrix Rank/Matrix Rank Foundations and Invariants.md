...
## 1. Definition
**Matrix Rank** represents a fundamental algorithmic paradigm and structural invariant within **19. Number Theory**.
...
## 2. Mental Model
```text
Invariant State Machine for Matrix Rank:
+--------------------+        State Transition        +--------------------+
