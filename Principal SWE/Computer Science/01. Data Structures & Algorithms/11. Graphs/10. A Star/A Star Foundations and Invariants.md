...
## 1. Definition
**A Star** represents a fundamental algorithmic paradigm and structural invariant within **11. Graphs**.
...
## 2. Mental Model
```text
Invariant State Machine for A Star:
+--------------------+        State Transition        +--------------------+
