...
## 1. Definition
**Tarjan SCC** represents a fundamental algorithmic paradigm and structural invariant within **11. Graphs**.
...
## 2. Mental Model
```text
Invariant State Machine for Tarjan SCC:
+--------------------+        State Transition        +--------------------+
