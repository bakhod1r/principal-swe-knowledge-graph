---
title: "Johnson All Pairs Foundations and Invariants"
tags:
  - computer-science
  - algorithms
  - dsa
...
## 1. Definition
**Johnson All Pairs** represents a fundamental algorithmic paradigm and structural invariant within **11. Graphs**.
...
## 2. Mental Model
```text
Invariant State Machine for Johnson All Pairs:
+--------------------+        State Transition        +--------------------+
...
## 3. Usage
```go
// Production pattern for Johnson All Pairs
type JohnsonAllPairs struct {
    // Internal state descriptors and size invariants
    size int
}

func NewJohnsonAllPairs() *JohnsonAllPairs {
    return &JohnsonAllPairs{
        size: 0,
    }
}
```
