---
title: "Activity Selection Foundations and Invariants"
tags:
  - computer-science
  - algorithms
  - dsa
...
## 1. Definition
**Activity Selection** represents a fundamental algorithmic paradigm and structural invariant within **14. Greedy Algorithms**.
...
## 2. Mental Model
```text
Invariant State Machine for Activity Selection:
+--------------------+        State Transition        +--------------------+
...
## 3. Usage
```go
// Production pattern for Activity Selection
type ActivitySelection struct {
    // Internal state descriptors and size invariants
    size int
}

func NewActivitySelection() *ActivitySelection {
