---
title: "Suffix Automaton Foundations and Invariants"
tags:
  - computer-science
  - algorithms
  - dsa
...
## 1. Definition
**Suffix Automaton** represents a fundamental algorithmic paradigm and structural invariant within **17. String Algorithms**.
...
## 2. Mental Model
```text
Invariant State Machine for Suffix Automaton:
+--------------------+        State Transition        +--------------------+
...
## 3. Usage
```go
// Production pattern for Suffix Automaton
