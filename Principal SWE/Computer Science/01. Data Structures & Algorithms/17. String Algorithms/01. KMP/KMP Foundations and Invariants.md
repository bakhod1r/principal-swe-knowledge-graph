---
title: "KMP Foundations and Invariants"
tags:
  - computer-science
  - algorithms
  - dsa
...
## 1. Definition
**KMP** represents a fundamental algorithmic paradigm and structural invariant within **17. String Algorithms**.
...
## 2. Mental Model
```text
Invariant State Machine for KMP:
+--------------------+        State Transition        +--------------------+
