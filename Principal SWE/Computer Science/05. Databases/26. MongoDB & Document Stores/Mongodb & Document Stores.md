...
# 🏛️ Mongodb & Document Stores

Document database design and horizontal scaling: BSON serialization, flexible schema modeling (Embedding vs Referencing), WiredTiger storage engine (LSM/B-Tree), multi-document ACID transactions, Aggregation Pipeline stages, change streams, replica sets (Oplog), and horizontal sharded clusters.
